...
sys.path.append("../")
from dataloaders.qata_covid_19_hf_data import load_qata_covid19_dataset
...
def parse_args(input_args=None):
    ...
    parser.add_argument(
        "--validation_prompt",
        type=str,
        default="Bilateral pulmonary infection, two infected areas, all right lung and upper left lung.",
    ...
    parser.add_argument(
        "--output_dir",
        type=str,
        default="sd-naruto-model-lora-sdxl",
...
def main(args):
    ...
    if args.dataset_name == "qata_covid19":
        dataset = load_qata_covid19_dataset(args.train_data_dir)
    # else:
    #     data_files = {}
